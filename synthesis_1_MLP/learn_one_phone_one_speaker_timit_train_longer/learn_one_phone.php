...
!obj:pylearn2.train.Train {
    dataset: &train !obj:timit_data.TimitPredFramesForPhn {
        ...
        num_examples: <?php $num_examples = p( 10000 ); ?>,
        trainorvalid: 'train',
...
<?php $num_inputs = $xsamples+($speaker_info=='True')*26; ?>
    ...
    algorithm: !obj:pylearn2.training_algorithms.sgd.SGD {
        batch_size: 100,
        learning_rate: <?php p( $learning_rate ) ?>,
        #init_momentum: .5,
        monitoring_dataset: {
            'train': *train,
...
<?php $reg_const = choice( [0.01, 0.001, 0.0001, 0.00001, 0.000001, 0.000001, 0.000001, 0.000001, 0.0000001, '0.0' ] );?>
    ...
    extensions: [
        !obj:pylearn2.train_extensions.best_params.MonitorBasedSaveBest {
            channel_name: 'valid_objective',
            save_path: "<?php echo $speaker_id . '/best' . $seed .'-'.$learning_rate.'.pkl';?>",
        },
    ...
    save_path: "<?php echo $speaker_id . '/progress'.$seed.'-'.$learning_rate.'.pkl'?>",
    save_freq: 1
}

<?php
#$fn = $speaker_id . '_hparams.txt';
#if( !file_exists( $fn ) )
#{
#	file_put_contents( $fn,
#	"seed \t xsamples \t ysamples \t rescale \t speaker_info \t num_hidden_layers\t learning_rate \t Regularization \t Regularization const \n");
#}
#file_put_contents( $fn, $seed . "\t" . $xsamples . "\t" . $ysamples . "\t" . $rescale . "\t" . $speaker_info .
