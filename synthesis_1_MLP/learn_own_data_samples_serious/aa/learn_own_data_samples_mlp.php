...
<?php $reg_const = choice( [0.1, 0.01, 0.001, 0.0001, 0.00001, 0.000001, 0.000001, 0.000001, 0.000001, 0.0000001, '0.0' ] );?>
...
if( !file_exists( 'hparams.txt' ) )
{
	...
	"seed \t xsamples \t ysamples \t recenter_samples\t rescaling \t num_hidden_layers\t learning_rate\t Regularization\t Regularization const \n");
}
